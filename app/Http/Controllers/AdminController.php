...
class AdminController extends Controller
{
    ...
    public function insert_auth(Request $request)
    {
        ...
        return redirect()->route('adminauth')->with('success', 'Auth Created Successfully');
    }
    ...
    public function insert_service(Request $request)
    {
        ...
        return redirect()->route('adminservice')->with('success', 'Service Created Successfully');
    }
    ...
    public function make_appointment(Request $request)
    {
        ...
        return redirect()->route('admindashboard')->with('success', 'Appointment Created Successfully');
    } 
}
