...
class ProviderController extends Controller
{
    ...
    public function insert_auth(Request $request)
    {
        ...
        return redirect()->route('providerauth')->with('success', 'Auth Created Successfully');
    }
    ...
    public function insert_service(Request $request)
    {
        ...
        return redirect()->route('providerservice')->with('success', 'Service Created Successfully');
    }
    ...
    public function make_appointment(Request $request)
    {
        ...
        return redirect()->route('providerdashboard')->with('success', 'Appointment Created Successfully');
    } 
